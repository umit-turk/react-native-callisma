...
export default function DetailScreen(props) {
    ...
    useLayoutEffect(() => { //use layouteffect daha ekran oluşmadan çalışıryor ve arayüzde istediğimiz birşeyi değiştirebiliyoruz.
    ...
    return (
        <View>
            ...
            <Button title="customstack git" onPress={() => props.navigation.navigate("CustomStack")} />
        </View>
    )
}
